...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2024 a las 06:34:12
...
(7, 8, '2024-03-17', 'Rutina'),
(8, 1, '2024-03-18', 'Rutina'),
(9, 3, '2024-03-19', 'Cita de rutina');
...
(3, 'Madre', 15879426, 'Maracaibo', '1997-04-22', 'Direccion de Ejemplo 2', '0414-1414232', 'Ejemplo de trabajo', 'Zulia', 'Maracaibo', 'Departamento de ejemplo', 'Casada', 8);
...
--
ALTER TABLE `historial_medico`
  MODIFY `id_historialmedico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `otros_parientes`
  MODIFY `id_pariente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
